...
import 'package:url_launcher/url_launcher.dart'; // 🚀 WhatsApp & Insta link
import 'package:font_awesome_flutter/font_awesome_flutter.dart'; // 🚀 Social Icons

// 📁 Custom paths (Ensure these exist in your project)
...
void main() {
  ...
  // 🟢 Makes system nav bar transparent for a cleaner edge-to-edge look
...
class _FortuneEventAppState extends State<FortuneEventApp> {
  ...
  void initState() {
    super.initState();
    // 🚀 ROUTE LISTENER: Track if we are on the Contact page
    appRouter.routerDelegate.addListener(_onRouteChanged);
  }

  void _onRouteChanged() {
    final String location = appRouter.routerDelegate.currentConfiguration.uri.toString();
    final bool currentlyContact = location.contains('/contact');
  ...
  Future<void> _publishToGitHub(BuildContext context) async {
    ...
    if (secureToken.isEmpty) {
      _showSnackBar(context, '❌ Please enter your GitHub Token first!', Colors.redAccent.shade700);
      return;
    }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // 🔹 STRINGS REPLACEMENT (Upgraded Regex to handle varied spaces)
        ...
        stringReplacements.forEach((key, value) {
          // Robust Regex: handles any amount of spaces before/after '='
          newContent = newContent.replaceAll(
            RegExp(r"static String\s+" + key + r"\s*=\s*'.*?';"),
        ...
        boolReplacements.forEach((key, value) {
          newContent = newContent.replaceAll(
            RegExp(r"static bool\s+" + key + r"\s*=\s*.*?;"),
            "static bool $key = $value;"
          );
        });
      ...
      if (context.mounted) _showSnackBar(context, '❌ Network Error: $e', Colors.redAccent);
    }
  ...
  Future<void> _openWhatsApp() async {
    ...
    try {
      // Direct launch is more reliable than checking canLaunchUrl on modern Android/iOS devices
      await launchUrl(whatsappUri, mode: LaunchMode.externalApplication);
    } catch (e) {
      if (mounted) {
        _showSnackBar(context, '❌ Error opening WhatsApp. Is it installed?', Colors.redAccent);
      }
    }
  }
                            ...
                            children: [
                              ...
                              if (!_isContactPage) ...[
                                ...
                                AnimatedPositioned(
                                  ...
                                  bottom: themeProvider.isSelectionMode ? 145 : 95,
                                  right: 20,
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child: const Center(child: FaIcon(FontAwesomeIcons.instagram, color: Colors.white, size: 28)),
                                ...
                                AnimatedPositioned(
                                  duration: const Duration(milliseconds: 400),
                                  curve: Curves.easeOutBack,
                                  bottom: themeProvider.isSelectionMode ? 80 : 30,
                                  right: 20,
                                  child: GestureDetector(
                                    onTap: _openWhatsApp,
                                    child: Container(
                                      ...
                                      child: const Center(child: FaIcon(FontAwesomeIcons.whatsapp, color: Colors.white, size: 28)),
                                    ).animate(onPlay: (controller) => controller.repeat()).shimmer(duration: 2.seconds, color: Colors.white30),
                                  ),
                                ),
                              ],
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Container(
                          height: 50, width: 4, 
                          decoration: BoxDecoration(color: AppTheme.accent.withValues(alpha: 0.5), borderRadius: BorderRadius.circular(5))
                        )
                      ),
                    ),
                  ),
        ...
        child: AnimatedContainer(
          ...
          child: themeProvider.isSelectionMode
              ...
              : GestureDetector(
                  ...
                  onTap: () { _triggerSound(); themeProvider.toggleSelectionMode(); }, 
        ...
        child: ListView(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text("Opacity", style: AppTheme.getBodyStyle(fontSize: 12, color: Colors.white54).copyWith(fontWeight: FontWeight.w600)),
                Expanded(
                  child: Slider(
                    value: _panelOpacity, min: 0.4, max: 1.0, 
                    activeColor: AppTheme.accent, inactiveColor: Colors.white24, 
              ...
              children: [
                ElevatedButton.icon(
                  onPressed: () {
                    ...
                    setState(() { _panelWidth = 380.0; _panelOpacity = 0.95; });
                  },
              ...
              children: items.map((item) {
                ...
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: Text(
                      item.toUpperCase(), 
                      style: AppTheme.getBodyStyle(fontSize: 11, color: isSelected ? AppTheme.bg : Colors.white70).copyWith(fontWeight: isSelected ? FontWeight.w800 : FontWeight.w600, letterSpacing: 1.0)
                    ),
                  ),
                );
              }).toList(),
            ...
            children: items.map((item) {
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  width: isSelected ? 42 : 35, height: isSelected ? 42 : 35,
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
  ...
  Widget _buildToggle(String label, bool value, Function(bool) onChanged) {
    return Padding(
      ...
      child: GestureDetector(
        behavior: HitTestBehavior.opaque,
        onTap: () { _triggerSound(); onChanged(!value); },
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            ...
            Switch(
              ...
              onChanged: (v) { _triggerSound(); onChanged(v); }
            )
          ],
        ),
      ),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: Row(
              children: [
                ...
                const SizedBox(width: 15),
                Expanded(
                  child: Text("GOD MODE ACTIVE: CLICK ANY TEXT OR CARD TO EDIT", 
          ...
          TextButton.icon(
            onPressed: () { _triggerSound(); provider.toggleSelectionMode(); },
