              ...
              children: [
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    physics: AppTheme.scrollEffect == 'smooth' ? const BouncingScrollPhysics() : const ClampingScrollPhysics(),
                    child: Column(
                            ...
                            children: [
                              ...
                              _buildEditable(
                                ...
                                AppTheme.applyAnim(
                                  ...
                                  AppTheme.durationMs ~/ 3, // 🚀 ENGINE SYNC: Speed-linked delay
                                ),
                              ),
                            ],
                          ),
                          ...
                          child: Wrap(
                            ...
                            children: AppTheme.servicesData.map((data) {
                              return ServiceCard(
                                ...
                                // 🚀 ENGINE SYNC: Link fixed delays directly relative to the duration mode
                                delay: (data['delay'] ?? 100) * (AppTheme.durationMs ~/ 200),
